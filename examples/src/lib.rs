...
pub trait DemoService {
    ...
    #[fusen_rs::fusen_procedural_macro::asset(path = "/sayHelloV2-http")]
...
#[fusen_rs::fusen_procedural_macro::asset(path = "/dome")]
pub trait DemoServiceV2 {
    #[fusen_rs::fusen_procedural_macro::asset(path = "/sayHelloV3-http")]
